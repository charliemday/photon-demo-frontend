  ...
  return (
    <Box>
      ...
      <Box opacity={0.75} py={3}>
        <Body>
          List the keywords the user wants to rank for. We will use SEMRush to extract a list of
          URLs that are ranking for these keywords and use them to generate a list of seed keywords.
        </Body>
      </Box>
      <Box pt={6}>
        <GridInputForm
